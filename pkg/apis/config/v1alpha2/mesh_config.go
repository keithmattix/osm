...
type SidecarSpec struct {
	...
	// HTTPIdleTimeout defines the idle timeout for inbound HTTP connections (in seconds). A timeout of 0 disables timeouts entirely
	HTTPIdleTimeout int64 `json:"httpIdleTimeout,omitempty"`

	// TCPIdleTimeout defines the idle timeout for inbound TCP connections (in seconds). A timeout of 0 disables timeouts entirely
